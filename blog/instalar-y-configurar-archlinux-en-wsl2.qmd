...
:::{.callout-warning}
El instalador de este paquete de Docker es mantenido por la comunidad de Archlinux. Las distribuciones de Linux soportadas directamente desde Docker se pueden encontrar en [docs.docker.com/engine/install](https://docs.docker.com/engine/install).
:::
